...
namespace WeaponsOld.Shutter
{
    public class Shutter : MonoBehaviour
    {
        ...
        // [0..1]
        private float shutterPositionValue;
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawMesh(GetComponent<MeshFilter>().sharedMesh, transform.position + transform.forward * shutterParameters.slideDistance * -1, transform.rotation);
        }
    }
}